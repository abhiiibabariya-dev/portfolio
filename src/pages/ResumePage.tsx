    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.45fr_.85fr] gap-8">
        ...
        <aside className="space-y-7">
          <section><h2 className="font-mono text-[10px] text-[#c8a96b] tracking-widest mb-4">CONTACT</h2><div className="font-mono text-xs text-[#8a8a96] space-y-2"><a className="block hover:text-[#c8a96b]" href={`mailto:${PROFILE.email}`}>{PROFILE.email}</a><span className="block">{PROFILE.phone}</span><span className="block">{PROFILE.location}</span></div></section>
